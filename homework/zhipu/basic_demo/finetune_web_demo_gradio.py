...
MODEL_PATH = os.environ.get('MODEL_PATH', '/root/autodl-tmp/models/chatglm3/20240406190542')
...
def load_model_and_tokenizer(
    ...
    if (model_dir / 'adapter_config.json').exists():
        print(f"Loading adapter_config.json from {model_dir}")
...
with gr.Blocks() as demo:
    gr.HTML("""<h1 align="center">ChatGLM3-6B Gradio finetune Demo(DataSet:AdvertiseGen)</h1>""")
    chatbot = gr.Chatbot()
